...
function updateData() {
  data = str(saveStatus)+","+str(runStatus)+","+str(round(slider.value()))+","+str(round(slider1.value()))+","+str(round(slider2.value()))+","+str(round(slider.value()))+","+str(gripperValue) +","+str(speedSlider)+","+str(accelerationSlider);
